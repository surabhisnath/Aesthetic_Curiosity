...
{
  # Read data
  data <- read.csv("../../data/complexity-extended/data.csv")
...
models <- list(
  ...
  "LSC + underlying_LSC + intricacy + underlying_intricacy + ((underlying_LSC + underlying_intricacy) | subject)",
  "LSC + underlying_LSC + intricacy + underlying_intricacy + ((intricacy + underlying_intricacy) | subject)",
  "LSC + underlying_LSC + intricacy + underlying_intricacy + ((LSC + underlying_LSC + intricacy + underlying_intricacy) | subject)"
)
