    ...
    for dirn in dirns:
        ...
        for state1 in states:
            for state2 in states:
                conditional, joint = get_joint_conditional(
                    state1, state2, dirn, grid, grid_size
                )
                if conditional != 0:
...
if __name__ == "__main__":
    ...
    assert calculate_local_spatial_complexity(grid_with_one_centre, grid_size) == (
        0.015480986966185604,
        0.0,
    )
